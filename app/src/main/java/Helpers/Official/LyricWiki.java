...
public class LyricWiki {
    ...
    public static Lyrics Find(String artist, String title) throws UnsupportedEncodingException {
        ...
        try {
            ...
            String encodedSong = URLEncoder.encode(title, StandardCharsets.UTF_8.toString());
            ...
            url = URLDecoder.decode(json.get("url").getAsString(), StandardCharsets.UTF_8.toString());
            ...
            encodedSong = URLEncoder.encode(title, StandardCharsets.UTF_8.toString());
    ...
    public static Lyrics fromURL(String url, String artist, String song) throws UnsupportedEncodingException {
        ...
        artist = URLDecoder.decode(artist, StandardCharsets.UTF_8.toString());
        song = URLDecoder.decode(song, StandardCharsets.UTF_8.toString());
    ...
    private static String getUrlAsString(URL URl){
        try {
            return IOUtils.toString(URl,StandardCharsets.UTF_8.toString());
        } catch (IOException e) {
            //e.printStackTrace();
            return "";
        }
