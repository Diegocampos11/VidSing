...
public class Genius {
    ...
    */
    ...
    public static Lyrics Find(String originalArtist, String originalTitle) {
        ...
        String url = "";
        try{
            String geniusRequest = "https://api.genius.com/search?access_token=FfgPFFMHnRqh4d0Yo4NvxkdqDMK1BnlWCxm7GnXUSLtS9dLB2u3ZVhkEB2h6qeZX&q=" + originalArtist;//.replaceAll(" ", "+")
